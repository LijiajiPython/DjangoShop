# Generated by Django 2.1.8 on 2019-07-25 11:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods_under', models.IntegerField(default=1, verbose_name='是否下架')),
            ],
        ),
        migrations.CreateModel(
            name='GoodsImg',
            fields=[
                ...
                ('goods_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AppShop.Goods', verbose_name='商品id')),
            ],
        ),
        migrations.CreateModel(
            name='GoodsType',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.ImageField(blank=True, null=True, upload_to='appshop/img', verbose_name='用户头像')),
        ...
        migrations.AddField(
            model_name='store',
            name='type',
            field=models.ManyToManyField(to='AppShop.StoreType', verbose_name='店铺类型'),
        ),
        migrations.AddField(
            model_name='goods',
            name='goodstype_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AppShop.GoodsType', verbose_name='所属商品种类'),
        ),
        migrations.AddField(
            model_name='goods',
            name='store_id',
            field=models.ManyToManyField(to='AppShop.Store', verbose_name='商品店铺'),
        ),
    ]
